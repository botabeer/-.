...
def game_header(icon, title, subtitle):
    """هيدر موحد للألعاب - ثري دي زجاجي مع الشعار"""
    return [
        # شعار الحوت في دائرة
        {
            "type":"box",
            "layout":"vertical",
            "contents":[
                {"type":"image","url":"https://i.imgur.com/qcWILGi.jpeg","size":"60px","aspectMode":"cover"}
            ],
            "width":"60px",
            "height":"60px",
            "cornerRadius":"30px",
        ...
        # العنوان مع الأيقونة
        {"type":"text","text":f"{icon} {title}","size":"xl","weight":"bold","color":C['cyan'],"align":"center","margin":"md"},
        # العنوان الفرعي
